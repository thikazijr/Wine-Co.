...
<head>
    ...
    <title>Contact Us - Wine & Co. Eswatini</title>
            ...
            <div class="col-md-6 mx-auto">
                <div class="card p-4">
                    ...
                    <div class="text-center mb-4">
                        <p><i class="fas fa-phone me-2"></i> +268 1234 5678</p>
                        <p><i class="fas fa-envelope me-2"></i> hello@wineco.co.sz</p>
                        <p><i class="fas fa-map-marker-alt me-2"></i> Mbabane, Eswatini</p>
                    </div>
                    <hr>
